...
public class ProductsPage extends BasePage {
    ...
    private static final By CONTINUE_SHOPPING_BTN =
    ...
    public ProductDetailsPage viewProductDetailsByProductId(String productId) {
        ...
        By viewProduct =
                By.cssSelector(
                        ".choose .nav.nav-pills.nav-justified a[href='/product_details/" + productId + "']");
        // click(viewProduct);
    ...
    public String getProductNameById(String productId) {
        ...
        return addToCartBtn
                .findElement(By.xpath("./ancestor::div[contains(@class,'productinfo')]/p"))
                .getText();
    }
    ...
    public void addProductToCartById(String productId) {
        ...
        // Preuve d'action : on attend l'apparition de la confirmation "Added" qui apparaît après "Add
        // to cart"
