...
public class ProductDetailsPage extends BasePage {
    ...
    private static final By RATING_IMG = By.cssSelector(".product-details .product-information img[src*='rating']");
    ...
    public String availability() {
        assertLoaded();
        WebElement productInformation = driver.findElement(PRODUCT_INFORMATION);
        return productInformation.findElement(By.xpath(".//p[b[normalize-space()='Availability:']]")).getText();
    }

    public String condition() {
        assertLoaded();
        WebElement productInformation = driver.findElement(PRODUCT_INFORMATION);
        return productInformation.findElement(By.xpath(".//p[b[normalize-space()='Condition:']]")).getText();
    }

    public String brand() {
        assertLoaded();
        WebElement productInformation = driver.findElement(PRODUCT_INFORMATION);
        return productInformation.findElement(By.xpath(".//p[b[normalize-space()='Brand:']]")).getText();
    }
