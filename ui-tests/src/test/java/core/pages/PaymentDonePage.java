...
public class PaymentDonePage extends BasePage {
    ...
    public static final By CONFIRMATION_MSG = By.xpath("//p[contains(normalize-space(),'Congratulations! Your order has been confirmed!')]");
   ...
   public void assertLoaded() {
        new WebDriverWait(driver, Duration.ofSeconds(8)).until(ExpectedConditions.visibilityOfElementLocated(ORDER_PLACED));
