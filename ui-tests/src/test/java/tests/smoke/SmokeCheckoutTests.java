...
public class SmokeCheckoutTests extends BaseTest {
    /**
     * CT-ID : CT-CHECKOUT-001 EX-ID : EX-19
     *
     * <p>Objectif : Accéder au formulaire de paiement depuis le panier
     * Critères de réussite :
     * - Le formulaire de paiement s'affiche avec tous les champs attendus visibles (nom, carte, CVC, expiration)
     ...
     *
     * <p>Note stabilité : - Test exécuté sur un site public (pubs/overlays possibles) --> moyen de contournement présent dans le code
     */
    @Test(
            groups = {"ui", "checkout", "smoke"},
            description = "CT-CHECKOUT-001 / EX-19 / Accéder au formulaire de paiement depuis le panier")
