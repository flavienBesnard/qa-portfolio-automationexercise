...
public class CartTests extends BaseTest {
    ...
    /**
     * CT-ID : CT-CART-004 EX-ID : EX-16
     *
     * <p>Objectif : Suppression d'un produit du panier Critères de réussite : - Le produit supprimé
     * disparaît immédiatement de la liste - Les autres produits restent inchangés - Aucun
     * comportement inattendu n'est observé
     *
     * <p>Préconditions : 1. Utilisateur connecté 2. Panier contenant au moins 2 produits différents
     *
     * <p>Note stabilité : - Test exécuté sur un site public (pubs/overlays possibles) --> mécanisme
     * de contournement présent dans le code
     */
    @Test(
            groups = {"ui", "cart", "regression"},
            description = "CT-CART-004 / EX-16 / Suppression d'un produit du panier")
    ...
    /**
     * CT-ID : CT-CART-002 EX-ID : EX-17
     * <p>
     * Objectif : Total du panier calculé correctement
     * Critères de réussite :
     * - Pour chaque ligne, le sous-total = prix unitaire*quantité
    ...
    @Test(
            groups = {"ui", "cart", "regression"},
            description = "CT-CART-002 / EX-17 / Total du panier calculé correctement")
