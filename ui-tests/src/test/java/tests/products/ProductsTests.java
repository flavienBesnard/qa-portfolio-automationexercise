...
public class ProductsTests extends BaseTest {
    /**
     * CT-ID : CT-PRODUCTS-005
     * EX-ID : EX-11
     *
     * Objectif : Affichage des informations minimales sur la fiche produit
     * Critères de réussite :   - Le nom du produit est affiché et non vide
     ...
     *
     * Préconditions : 1. L'utilisateur est sur la page "Products"
     *
     * Note stabilité : - Test exécuté sur un site public (pubs/overlays possibles) --> mécanisme de contournement présent dans le code
     */
@Test(groups = {"ui","products","regression"}, description = "CT-PRODUCTS-005 / EX-11 / Affichage des informations minimales sur la fiche produit")
